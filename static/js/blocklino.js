...
BlocklyDuino.init = function() {
  var called = false;
  var count = 0;
  while (!called && count < 1000) {
    count++;
    if (document.getElementById('content_blocks') != null){
...
BlocklyDuino.bindFunctions = function() {
  ...
  $( "li[role='tab']" ).on("click", function(){
    ...
    if(tabId == 'react-tabs-6'){
      $("#btn_start_action").hide();
      $("#btn_stop_action").hide();
    }else{
      $("#btn_start_action").show();
      $("#btn_stop_action").show();
    }
  });
...
BlocklyDuino.loadToolboxDefinition = function(toolboxFile) {
  ...
  // });
  var toolboxXml = '<xml id="toolbox" style="display: none">'+
  '<parametre id="defaultCategories">CAT_LOGIC,CAT_MATH,CAT_TEXT,CAT_VARIABLES,CAT_FUNCTIONS,CAT_ARDUINO,CAT_actionneur,CAT_ultrason,CAT_com</parametre>'+
  '<category name="Logic" colour="#696969" id="CAT_LOGIC">'+
  ...
  '  <block type="controls_for"><value name="FROM"><block type="math_number"><field name="NUM">1</field></block></value><value name="TO">'+
  '  <block type="math_number"><field name="NUM">10</field></block></value><value name="BY">'+
  ...
  '</category>'+
  '<category name="Text" colour="#FD6C9E" id="CAT_TEXT">'+
  ...
  '</category>'+
  '<category name="Variable" colour="#FFA500" id="CAT_VARIABLES">'+
  '  <block type="variables_get"></block>'+
  '  <block type="variables_set"></block>'+
  '  <block type="variables_set"><value name="VALUE"><block type="variables_set_type"></block></value></block>'+
  '  <block type="variables_set_type"></block>'+
  '</category>'+
  //'<category name="Function" custom="PROCEDURE" colour="#FF0000" id="CAT_FUNCTIONS"></category>'+
  '<category name="Arduino" colour="#4a235a" id="CAT_ARDUINO">'+
    ...
    '<block type="re_trai"></block>'+
    '<block type="re_phai"></block>'+
    //'<block type="di_thang_lech_trai"></block>'+
    '<block type="check_sieu_am"></block>'+
    '<block type="check_do_duong_trai"></block>'+
    '<block type="check_do_duong_phai"></block>'+
    '<block type="check_anh_sang"></block>'+
    '<category name=" - Time" colour="#aaaaaa" id="CAT_ARDUINO_TIME">'+
      '<block type="base_delay"></block>'+
    '</category>'+
  '</category>'+
  '<category name="Actuator" colour="#00929F" id="CAT_actionneur">'+
    '<category name=" - LED" colour="#00929F" id="CAT_del">'+
...
//append COM selector
var uploaderElement = '<span class="uploader">'+
        '<select id="uploader_ports">'+
          '<option value="COM1" data-port="COM1">COM1</option>'+
          '<option value="COM2" data-port="COM2">COM2</option>'+
          '<option value="COM3" data-port="COM3" selected="selected">COM3</option>'+
          '<option value="COM4" data-port="COM4">COM4</option>'+
          '<option value="COM5" data-port="COM5">COM5</option>'+
        '</select>'+
        '<select id="uploader_boards">'+
          '<option data-fqbn="arduino:avr:nano:cpu=atmega328" selected="selected">Arduino Nano ATMEGA328</option>'+
        '</select>'+
        ...
        '</button>'+
      '</span>';
//append preview arduino code
var preElement = '<div id="toggle" class="modal-content">'+// style="display: none;">'+
        '<pre id="pre_previewArduino"></pre>'+
        '<button id="btn_saveino" class="btn btn-default">'+
          '<span class="fa fa-floppy-o"> </span>'+
        '</button>'+
      '</div>';
$('#content_blocks').append(uploaderElement);
$('#content_blocks').append(preElement);
};
