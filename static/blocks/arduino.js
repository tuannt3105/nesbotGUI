...
/*Blockly.Blocks["move_forward"] = {
  init: function() {
    ...
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendValueInput("DELAY_TIME", "Number").appendField("Đi thẳng với tốc độ ").setCheck("Number");
    this.appendDummyInput().appendField(new Blockly.FieldTextInput("150"), "unite");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks["move_forward"] = {
  init: function() {
    this.appendDummyInput().appendField("Đi thẳng với tốc độ ").appendField(new Blockly.FieldTextInput("150"), "TEXT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#00929F");
...
Blockly.Blocks["move_backward"] = {
  init: function() {
    this.appendDummyInput().appendField("Đi lùi với tốc độ ").appendField(new Blockly.FieldTextInput("150"), "TEXT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#00929F");
    this.setTooltip(Blockly.Msg.blink_tooltip);
...
Blockly.Blocks["xoay_trai"] = {
  init: function() {
    this.appendDummyInput().appendField("Xoay trái với tốc độ ").appendField(new Blockly.FieldTextInput("150"), "TEXT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#00929F");
    this.setTooltip(Blockly.Msg.blink_tooltip);
...
Blockly.Blocks["xoay_phai"] = {
  init: function() {
    this.appendDummyInput().appendField("Xoay phải với tốc độ ").appendField(new Blockly.FieldTextInput("150"), "TEXT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#00929F");
    this.setTooltip(Blockly.Msg.blink_tooltip);
...
Blockly.Blocks["re_trai"] = {
  init: function() {
    this.appendDummyInput().appendField("Rẽ trái với tốc độ ").appendField(new Blockly.FieldTextInput("150"), "TEXT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#00929F");
    this.setTooltip(Blockly.Msg.blink_tooltip);
...
Blockly.Blocks["re_phai"] = {
  init: function() {
    this.appendDummyInput().appendField("Rẽ phải với tốc độ ").appendField(new Blockly.FieldTextInput("150"), "TEXT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#00929F");
    this.setTooltip(Blockly.Msg.blink_tooltip);
...
/*Blockly.Blocks["di_thang_lech_trai"] = {
  init: function() {
    this.appendDummyInput().appendField("Đi thẳng lệch trái với tốc độ ").appendField(new Blockly.FieldTextInput("150"), "TEXT");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#00929F");
    this.setTooltip(Blockly.Msg.blink_tooltip);
...
Blockly.Blocks['check_sieu_am'] = {
  init: function() {
    this.appendDummyInput().appendField("Nhận tín hiệu cảm biến siêu âm ");
    this.setOutput(true);
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.setTooltip("Nhận tín hiệu cảm biến siêu âm ")
  }
};
Blockly.Blocks['check_do_duong_trai'] = {
  init: function() {
    this.appendDummyInput().appendField("Nhận tín hiệu cảm biến dò đường trái");
    this.setOutput(true);
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.setTooltip("Nhận tín hiệu cảm biến dò đường trái")
  }
};
Blockly.Blocks['check_do_duong_phai'] = {
  init: function() {
    this.appendDummyInput().appendField("Nhận tín hiệu cảm biến dò đường phải");
    this.setOutput(true);
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.setTooltip("Nhận tín hiệu cảm biến dò đường phải")
  }
};
Blockly.Blocks['check_anh_sang'] = {
  init: function() {
    this.appendDummyInput().appendField("Nhận tín hiệu cảm biến ánh sáng");
    this.setOutput(true);
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.setTooltip("Nhận tín hiệu cảm biến ánh sáng")
  }
};
/*	*/
